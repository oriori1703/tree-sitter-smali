...
HOMEPAGE_URL := https://github.com/tree-sitter-grammars/tree-sitter-smali
VERSION := 1.0.0
...
install: all
	install -d '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/smali '$(DESTDIR)$(INCLUDEDIR)'/tree_sitter '$(DESTDIR)$(PCLIBDIR)' '$(DESTDIR)$(LIBDIR)'
...
ifneq ($(wildcard queries/*.scm),)
	install -m644 queries/*.scm '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/smali
endif
...
uninstall:
	...
	$(RM) -r '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/smali
